        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo $row['sub_kegiatan']; ?></td> <!-- Menampilkan sub kegiatan -->
                    <td><?php echo $row['kode_sub_kegiatan']; ?></td> <!-- Menampilkan kode sub kegiatan -->
                    <td><?php echo $row['kd_rek']; ?></td>
                    ...
                    <td><?php echo $row['bulan']; ?></td> <!-- Tampilkan bulan -->
                </tr>
                <?php endwhile; ?>
            </tbody>
        </table>
